const pillars = [
  {
    ...
    description:
      'We build intelligent systems that turn manual workflows into scalable growth engines — AI automation, smart capture, and workflow orchestration.',
  ...
  },
  {
    ...
    description:
      'NeoRealiti pioneered holographic experiences in Oman. We\'re establishing new standards in AR, VR, and spatial computing for businesses.',
  ...
  },
  {
    ...
    description:
      'We culture innovation, build frameworks for adoption, and help organizations stay ahead in a rapidly evolving technological landscape.',
  ...
  },
  {
    ...
    description:
      'Every solution we build is measured by real business outcomes — more leads, faster responses, higher revenue, and deeper connections.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl ${pillar.iconBg} flex items-center justify-center text-2xl mb-4`}>
                {pillar.icon}
              </div>
