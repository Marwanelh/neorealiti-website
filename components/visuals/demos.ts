...
export interface Demo {
  ...
  title: string
  description: string
  category: 'gamification' | 'interactive' | 'ai-ml' | 'xr' | 'data-viz' | 'digital-twin' | 'lab'
  tech: string
  thumbnail: string
  camera: boolean
  html: string
...
<\/script></body></html>`,
  ...
  {
    id: 'paint-particles',
    title: 'Paint Particles',
    description: 'Flowing paint particles mix and swirl through vector fields — hypnotic colour fluid simulation.',
    category: 'interactive',
    tech: 'p5.js · Vector Field · Fluid',
    thumbnail: 'from-[#1a0505] via-[#2d0a1a] to-[#05051a]',
    camera: false,
    hint: 'Move mouse to steer the flow',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}body{background:#000}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.9.0/lib/p5.js"><\/script></head><body><script src="/visuals/paint-particles/mySketch.js"><\/script></body></html>`,
  },

  {
    id: 'circles-squares',
    title: 'Circles & Squares',
    description: 'Geometric shapes morph and multiply with cursor interaction — an exploration of form, rhythm and transformation.',
    category: 'interactive',
    tech: 'p5.js · Generative · Interactive',
    thumbnail: 'from-[#05050a] via-[#0a1428] to-[#05050a]',
    camera: false,
    hint: 'Move and click to transform the geometry',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}body{background:#000}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.9.0/lib/p5.js"><\/script></head><body><script src="/visuals/circles-squares/mySketch.js"><\/script><script src="/visuals/circles-squares/Block.js"><\/script><script src="/visuals/circles-squares/Cursor.js"><\/script></body></html>`,
  },

  {
    id: 'typewriter-art',
    title: 'Typewriter Art',
    description: 'William Butler Yeats\' "The Second Coming" rendered through a generative typewriter — text as texture, poetry as pattern.',
    category: 'interactive',
    tech: 'p5.js · Typography · Generative',
    thumbnail: 'from-[#0a0a08] via-[#141410] to-[#0a0a08]',
    camera: false,
    hint: 'Watch the verse unfold',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}body{background:#0a0a08}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.9.0/lib/p5.js"><\/script></head><body><script src="/visuals/typewriter-art/mySketch.js"><\/script></body></html>`,
  },

  {
    id: 'spherical-text',
    title: 'Spherical Magnification',
    description: 'A lens of text — characters arranged in a grid with a spherical magnification effect that follows your cursor.',
    category: 'interactive',
    tech: 'p5.js · Optics · Typography',
...

  {
    id: 'nodes-network',
    title: 'Nodes Network',
    description: 'Planes and nodes weave a living network visualization — data relationships rendered as spatial journeys.',
    category: 'data-viz',
    tech: 'p5.js · Network · Data',
    thumbnail: 'from-[#0a1428] via-[#0f2040] to-[#0a1428]',
    camera: false,
    hint: 'Watch the network self-organise',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}body{background:#fff}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.9.0/lib/p5.js"><\/script></head><body><script src="/visuals/nodes-network/Node.js"><\/script><script src="/visuals/nodes-network/Connection.js"><\/script><script src="/visuals/nodes-network/Plane.js"><\/script><script src="/visuals/nodes-network/mySketch.js"><\/script></body></html>`,
  },

  {
    id: 'philosophy-text',
    title: 'Philosophy Text Viz',
    description: 'Plato\'s Parmenides rendered as flowing teal typography — philosophical text transformed into a contemplative visual experience.',
    category: 'data-viz',
    tech: 'p5.js · Typography · Data',
...

  {
    ...
    description: 'Procedural WebGL terrain with real-time camera navigation — a living landscape data visualisation.',
    category: 'data-viz',
    tech: 'p5.js · WebGL · Procedural',
    thumbnail: 'from-[#0a1e0a] via-[#142814] to-[#0a1e0a]',
    camera: false,
    hint: 'Move mouse to orbit the terrain',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}body{background:#000}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.9.0/lib/p5.js"><\/script></head><body><script src="/visuals/terrain-3d/Terrain.js"><\/script><script src="/visuals/terrain-3d/Display.js"><\/script><script src="/visuals/terrain-3d/Listeners.js"><\/script><script src="/visuals/terrain-3d/mySketch.js"><\/script></body></html>`,
  },

  {
    id: 'fluvia-terrain',
    title: 'Fluvia — Erosion Sim',
    description: 'Real-time hydraulic erosion simulation on a procedural 3D terrain. Watch rivers carve valleys over time.',
    category: 'digital-twin',
    tech: 'GLSL · WebGL · Physics Sim',
    thumbnail: 'from-[#1a1408] via-[#2d3320] to-[#1a2d1a]',
    camera: false,
    hint: 'Drag to orbit · Scroll to zoom · Use panel to tweak erosion parameters',
    html: `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><script src="https://cdn.jsdelivr.net/npm/p5@1.11.11/lib/p5.min.js"><\/script><script type="module">import{Pane}from'https://cdn.jsdelivr.net/npm/tweakpane@4.0.3/dist/tweakpane.min.js';window.Tweakpane={Pane};<\/script></head><body style="margin:0;overflow:hidden"><script src="/visuals/fluvia/Quaternion.js"><\/script><script src="/visuals/fluvia/Terrain.js"><\/script><script src="/visuals/fluvia/Solver.js"><\/script><script src="/visuals/fluvia/Camera.js"><\/script><script src="/visuals/fluvia/Renderer.js"><\/script><script src="/visuals/fluvia/Analyser.js"><\/script><script src="/visuals/fluvia/Media.js"><\/script><script src="/visuals/fluvia/GUI.js"><\/script><script src="/visuals/fluvia/Manager.js"><\/script><script src="/visuals/fluvia/sketch.js"><\/script></body></html>`,
  },

  {
    id: 'body-pose-art',
    title: 'Body Pose Art',
    description: 'ML5 body pose detection turns your movements into abstract art — your skeleton becomes a living brush.',
    category: 'ai-ml',
    tech: 'ML5 · Body Pose · p5.js',
  ...
  {
    id: 'hand-paint-mediapipe',
    title: 'Hand Paint',
    description: 'MediaPipe hand tracking drives a generative paint system — draw in mid-air with shader-park brushes.',
    category: 'ai-ml',
    tech: 'MediaPipe · Shader Park · p5.js',
    thumbnail: 'from-[#0a0514] via-[#140a28] to-[#0a0514]',
    camera: true,
    hint: 'Allow camera access · Use your hands to paint in the air',
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{margin:0;padding:0;overflow:hidden}</style><script src="https://cdn.jsdelivr.net/npm/p5@1.8.0/lib/p5.js"><\/script><script src="https://cdn.jsdelivr.net/npm/shader-park-core@0.2.8/dist/shader-park-p5.min.js"><\/script><script src="https://cdn.jsdelivr.net/gh/msawired/OPC@0.6.0/opc.js"><\/script></head><body><script src="/visuals/hand-paint/landmarks.js"><\/script><script src="/visuals/hand-paint/mySketch.js"><\/script></body></html>`,
  },
]
